...
import Student_leaveNotices_modal from "../modal/Student_leaveNotices_modal.component.tsx";
import {
  LeaveNotice_Choice,
...
const Student_leaveNotices_table_row = (props: CurrentComponentProp) => {
...
export default Student_leaveNotices_table_row;
