...
import Head_leaveNotices_evaluate_modal from "./Head_leaveNotices_evaluate_modal.component";
...
const Head_leaveNotices_modal = (props: CurrentComponentProp) => {
    ...
    <Custom_Modal
      ...
      <div className="flex flex-col w-full gap-4">
        ...
        {teacher_access_only(userInfo.profile_position) ? (
          <>
            <Head_leaveNotices_evaluate_modal
...
export default Head_leaveNotices_modal;
