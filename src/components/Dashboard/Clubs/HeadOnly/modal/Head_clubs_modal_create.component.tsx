...
const Head_clubs_modal_create = (props: CurrentComponentProp) => {
  ...
  const [clubCreateObject, setClubCreateObject] = useState({
    club_name: "",
    club_major: userInfo.profile_major,
    club_teacher: [0],
    club_description: "",
    club_image: "",
    club_status: 1,
    ...
    <Custom_Modal
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <Info_submit_button
          ...
          successText={t("Admin_Clubs_create_modal_submit_success_message")}
          icon="fa-solid fa-plus"
...
export default Head_clubs_modal_create;
