...
import Admin_club_modal_update_teachers from "./Admin_club_modal_update_teachers.component";
import {
  Major_Name,
  Major_Name_German,
  Major_Name_Korean,
...
const Admin_club_modal_update = (props: CurrentComponentProp) => {
  ...
  return (
    <Custom_Modal
      ...
      altTitle={t("Admin_Clubs_update_modal_submit_success_message")}
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <div className="flex flex-col gap-2 my-2">
          ...
          <Admin_club_modal_update_teachers
            club={club}
