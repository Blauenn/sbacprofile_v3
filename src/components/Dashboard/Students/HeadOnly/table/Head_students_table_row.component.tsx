...
import Head_student_modal_update from "../modal/Head_students_modal_update.component";
...
const Head_students_table_row = (props: CurrentComponentProp) => {
...
export default Head_students_table_row;
