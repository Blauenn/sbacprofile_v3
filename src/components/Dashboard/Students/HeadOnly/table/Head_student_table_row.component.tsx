...
import Head_student_modal_update from "../modal/Head_student_modal_update.component";
...
const Head_student_table_row = (props: CurrentComponentProp) => {
...
export default Head_student_table_row;
